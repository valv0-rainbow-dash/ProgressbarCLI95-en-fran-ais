...
def detectSave():
    ...
    if saveFileExists == True:
        print('Save file detecté.')
    else:
        print('Fichier de sauvegarde non trouvé. Voulez-vous en créer un? (Y/N)')
...
def detectSettings():
    ...
    if settingsFileExists == True:
        print('Settings file detecté')
    else:
        print('Fichier de paramètres non trouvé. Voulez-vous en créer un? (Y/N)')
